...
class AuditLogModel extends Model
{
    ...
    public const PRODUCT_FIELDS = [
        ...
        'package_buying_price' => 'Package buying price',
        'units_per_pack'      => 'Units per package',
        'pack_unit'           => 'Package label',
        'pack_price'          => 'Wholesale package price',
        'retail_pack_price'   => 'Retail package price',
