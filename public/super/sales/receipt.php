<?php
// public/super/sales/receipt.php?id=N — owner-side entry point for viewing a
// direct-sale receipt. Same page/logic as the staff till uses (receipt
...
require __DIR__ . '/../../staff/sales/receipt.php';
